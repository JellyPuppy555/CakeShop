		...
		<div class="container">
			<nav class="navbar navbar-default" role="navigation">
				<div class="navbar-header">
					...
					<h1 class="navbar-brand"><a href="${pageContext.request.contextPath }">师大西点</a></h1>
				</div>
				<!--navbar-header-->
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						...
						<c:choose><c:when test="${empty user }">
							...
							<li><a href="${pageContext.request.contextPath }/order_list.jsp" <c:if test="${param.flag==5 }">class="active"</c:if>>我的订单</a></li>
